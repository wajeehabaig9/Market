...
const ContractAdminPage2 = ({ route }) => {
    return (
        <SafeAreaView>
                    ...
                    <View>
                        ...
                        <View className="px-2">
                            ...
                            <View className="px-1 flex-row justify-between mt-5">
                                <Text className="text-[14px] font-black">CAPSICUM</Text>
                                <Image
                                    source={{
                                        uri: 'https://res.cloudinary.com/dzngpgki4/image/upload/v1740217823/capsicum_cp4vxc.png',
                                    }}
                        ...
                        <View>
                            <Text className="text-[7px] font-normal mt-5 px-2">
                                In 2024, capsicum production in Kenya is projected to experience an increase of 2% compared to 2023 production levels, with an annual production estimated at 3,834,618 metric tons1.
                                This growth is significant, and it’s worth noting that the Western and Southern districts are expected to produce the most substantial volumes of maize. Specifically, districts like Masinga (Machakos), Kilgoris (Narok), Mwala (Machakos),
                            </Text>
                        </View>
...
export default ContractAdminPage2;
